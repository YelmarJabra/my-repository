...
@app.route("/")
def home():
    return render_template("main.html", name = "Yelmar")
...
def greet():
    if "user" in request.args:
        ...
        return render_template("greet.html", user = "please add user name to the query string")
...
# greet?username=admin or whatever it is case sensitive
